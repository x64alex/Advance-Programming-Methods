...
public class SleepStmt implements IStmt{
    ...
    public SleepStmt(IntValue val){
        this.intValue = val;
    }

    public String toString() {
        return "Sleep("+intValue.toString()+")";
    }
    ...
    public PrgState execute(PrgState state) throws MyException {
        ...
        if(intType.equals(intValue.getType())){
            ...
            if(! v.equals(intValue)){
                ...
                stk.push(new WaitStmt(newValueExp));
            }
        }
        else{ throw new MyException("Not Int type in sleep\n");}
        return null;
    }

    @Override
    public IStmt deepCopy() {
        return new SleepStmt(intValue);
    }
